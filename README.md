...
- **MCP Server** - 35 tools pra usar com Claude, Gemini Antigravity, Cursor e outros
...
| `packages/mcp` | MCP Server HTTP (35 tools) | 3002 |
...
| `instapost-mcp` | MCP Server (35 tools) | 3002 |
...
| `mcp-server` | MCP Server (35 tools) | 3002 |
| `renderer` | Puppeteer (HTML para PNG) | 3003 |
...
O OpenHive expoe 35 tools via Model Context Protocol. Ha duas formas de conectar:
